        ...
        <div class="wrap wd668">
            <div class="container">
                <div class="form_txtInput">
                    ...
                    <div class="join_form">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <th><span>이메일</span></th>
                                    <td><input type="text" placeholder="Email을 입력하세요."></td>
                                </tr>
                                <tr>
                                    <th><span>이름</span></th>
                        ...
                        <!--         <tr class="email">
                                ...
                                <tr> -->
                                    ...
                                    <td><input type="text" placeholder="후대폰 번호를 입력하세요."></td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="btn_wrap">
                        <a href="javascript:;" style="height: 60px; width: 170px; margin-bottom: 100px;">가입하기</a>
                    </div>
                </div> <!-- form_txtInput E -->
            </div><!-- content E-->
        </div> <!-- container E -->
