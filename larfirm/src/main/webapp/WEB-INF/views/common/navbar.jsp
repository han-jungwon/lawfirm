...
<header>
	<nav class="navbar navbar-expand-xl navbar-dark fixed-top bg-dark">
		<a class="navbar-brand" href="/memberinfo"> <img
			src="/hansong/resources/images/logo.png" style="width: 200px;">
		</a>
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<ul class="navbar-nav mr-auto">
				<li>
					<div class="dropdown">
						<button class="btn click" type="button" id="dropdownMenu2"
							data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							법무법인 송한</button>
						<div class="dropdown-menu" aria-labelledby="dropdownMenu2">
							<button class="dropdown-item" type="button"
								onclick="location.href='/hansong/menu/lawyer'">변호사 소개</button>
				...
				<li>
					<div class="dropdown">
						<button class="btn click" type="button" id="dropdownMenu2"
							data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
							onclick="location.href = '/memberinfo'">공지사항</button>
					</div>
				</li>
				<li>
					<div class="dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenu2">
							<button class="dropdown-item" type="button"
								onclick="location.href = '#' ">언론보도</button>
			...
			<div style="display: flex;">
				<input id="navInputSearch" class="form-control mr-sm-2" type="text"
					placeholder="Search" aria-label="Search">
				<button id="navBtnSearch"
					class="btn btn-outline-success my-2 my-sm-0" type="button">Search</button>
			</div>
