...
!function () {
    ...
    jQuery.extend(!0, t, {
        stopKenBurn: function (t) {
            ...
            var r = t.data(), n = t.find(".defaultimg"), s = n.data("lazyload") || n.data("src"),
            ...
            var d = function (t, e, a, r, n, s, i) {
                var o = t * a, d = e * a, l = Math.abs(r - o), h = Math.abs(n - d), p = new Object;
                ...
                var r = a.scalestart / 100, n = a.scaleend / 100,
                ...
                {
                    var o = new Object, d = t * r, h = (d / a.owidth * a.oheight, t * n);
                ...
                var c = g.start.r - g.start.l, b = g.start.b - g.start.t, u = g.end.r - g.end.l, f = g.end.b - g.end.t;
            ...
            var p = t.data("kenburn"), g = p.parent(), c = h(i, o, r), b = new punchgs.TimelineLite;
