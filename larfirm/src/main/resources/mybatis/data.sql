...
(
    ...
    PHONE           VARCHAR2(50) ,
    REGI_ID         NUMBER(10)   NOT NULL,
    REGI_DT         DATE         NOT NULL,
    UPDT_ID         NUMBER(10)   NOT NULL,
...
COMMENT ON COLUMN BOARD.BOARD_CATAGORY IS '카테고리';
...
COMMENT ON COLUMN BOARD.BOARD_RE_SEQ IS '참조 레벨';
COMMENT ON COLUMN BOARD.BOARE_READCOUNT IS '참조 순서';
...
(
    ...
    FOREIGN KEY (BOARD_ID)REFERENCES MEMBER(ID)
);
