...
COMMENT ON TABLE  COMMENTS IS '게시판 댓글';
COMMENT ON COLUMN COMMENTS.ID IS '댓글 번호';
COMMENT ON COLUMN COMMENTS.BOARD_ID IS '게시판 번호';
COMMENT ON COLUMN COMMENTS.MEMBER_ID IS '회원아이디';
COMMENT ON COLUMN COMMENTS.CONTENT IS '댓글 내용';
COMMENT ON COLUMN COMMENTS.REGI_ID IS '등록아이디';
COMMENT ON COLUMN COMMENTS.REGI_DT IS '등록날짜';
COMMENT ON COLUMN COMMENTS.UPDT_ID IS '수정아이디';
COMMENT ON COLUMN COMMENTS.UPDT_DT IS '수정날짜';
...
COMMENT ON COLUMN PARTICIPANT.USE_YN IS '사용여부';
