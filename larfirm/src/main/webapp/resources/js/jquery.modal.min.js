        ...
        var e, o = {
            ...
            s = a.append(n.template), i = {
                init: function () {
                    ...
                    t("body").css({overflow: "hidden", width: t("body").innerWidth()}).append(s)
                    ...
                    if (t.inArray(s, ["alert", "confirm", "prompt"]) > -1) e = l = 1 == d ? !0 : !1, "prompt" == s && (e = l = l && a.find("input.modal-prompt-input").length > 0 != 0 ? a.find("input.modal-prompt-input").val() : !1), i._modalHide(); else {
